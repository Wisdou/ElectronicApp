...
var TuiInputNumberComponent = class _TuiInputNumberComponent extends AbstractTuiNullableControl {
  ...
  get inputMode() {
    if (this.isIOS) {
      return this.isNegativeAllowed ? "text" : "decimal";
    }
    return "numeric";
  }
  ...
  onFocused(focused) {
    ...
    const nativeNumberValue = this.unfinishedValue ? maskitoParseNumber(this.unfinishedValue, this.numberFormat) : this.nativeNumberValue;
    this.unfinishedValue = null;
...
var TuiColorEditModule = class _TuiColorEditModule {
  ...
  static {
    this.ɵmod = ɵɵdefineNgModule({
      ...
      imports: [CommonModule, FormsModule, MaskitoDirective, TuiPrimitiveTextfieldModule, TuiTextfieldControllerModule, TuiInputNumberModule, TuiSelectModule, TuiDropdownOptionsDirective, TuiDropdownDriverDirective, TuiDropdownDirective, TuiDropdownComponent, TuiDropdownOpen, TuiDropdownOpenLegacy, TuiDropdownPortal, TuiDropdownManual, TuiDropdownHover, TuiDropdownContext, TuiDropdownPosition, TuiDropdownPositionSided, TuiDropdownSelection, TuiDataListComponent, TuiDataListDirective, TuiOption, TuiOptionNew, TuiOptionWithValue, TuiOptGroup, TuiButton],
      exports: [TuiColorEditComponent, TuiDropdownOptionsDirective, TuiDropdownDriverDirective, TuiDropdownDirective, TuiDropdownComponent, TuiDropdownOpen, TuiDropdownOpenLegacy, TuiDropdownPortal, TuiDropdownManual, TuiDropdownHover, TuiDropdownContext, TuiDropdownPosition, TuiDropdownPositionSided, TuiDropdownSelection, TuiDataListComponent, TuiDataListDirective, TuiOption, TuiOptionNew, TuiOptionWithValue, TuiOptGroup]
    });
  }
  static {
    this.ɵinj = ɵɵdefineInjector({
...
var TuiColorSelectorModule = class _TuiColorSelectorModule {
  ...
  static {
    this.ɵmod = ɵɵdefineNgModule({
      ...
      imports: [CommonModule, TuiButton, TuiSvgComponent, TuiColorPickerModule, TuiLinearMultiPickerModule, TuiActiveZone, TuiColorEditModule, TuiGroup, TuiPaletteModule, TuiChevron, TuiIcon, TuiHintComponent, TuiHintDirective, TuiHintOptionsDirective, TuiHintUnstyled, TuiHintDriver, TuiHintPosition, TuiHintHover, TuiHintOverflow, TuiHintDescribe, TuiHintHost, TuiHintManual, TuiHintPointer, TuiDataListComponent, TuiDataListDirective, TuiOption, TuiOptionNew, TuiOptionWithValue, TuiOptGroup],
      exports: [TuiColorSelectorComponent, TuiHintComponent, TuiHintDirective, TuiHintOptionsDirective, TuiHintUnstyled, TuiHintDriver, TuiHintPosition, TuiHintHover, TuiHintOverflow, TuiHintDescribe, TuiHintHost, TuiHintManual, TuiHintPointer, TuiDataListComponent, TuiDataListDirective, TuiOption, TuiOptionNew, TuiOptionWithValue, TuiOptGroup]
    });
  }
  static {
    this.ɵinj = ɵɵdefineInjector({
...
var TuiInputComponent = class _TuiInputComponent extends AbstractTuiControl {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      features: [ɵɵProvidersFeature([TUI_VALUE_ACCESSOR_PROVIDER, tuiAsFocusableItemAccessor(_TuiInputComponent), tuiAsDataListHost(_TuiInputComponent), tuiAsControl2(_TuiInputComponent)]), ɵɵHostDirectivesFeature([TuiDropdownFixed]), ɵɵInheritDefinitionFeature],
...
var TuiInputTagComponent = class _TuiInputTagComponent extends AbstractTuiMultipleControl {
  constructor() {
    ...
    this.textfieldOptions = inject(TUI_TEXTFIELD_OPTIONS2);
...
var TuiInputDateTimeComponent = class _TuiInputDateTimeComponent extends AbstractTuiControl {
  ...
  writeValue(value) {
    const transformed = this.valueTransformer ? this.valueTransformer.fromControlValue(value) : value;
    ...
    this.ɵcmp = ɵɵdefineComponent({
      ...
      template: function TuiInputTimeComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          ɵɵadvance();
          ɵɵproperty("disabled", ctx.disabled)("focusable", ctx.focusable)("invalid", ctx.computedInvalid)("maskito", ctx.maskOptions)("nativeId", ctx.nativeId)("pseudoActive", ctx.pseudoActive)("pseudoFocus", ctx.innerPseudoFocused)("pseudoHover", ctx.pseudoHover)("readOnly", ctx.readOnly)("tuiTextfieldFiller", ɵɵpipeBind1(2, 16, ctx.getFiller$(ctx.mode)) || "")("tuiTextfieldIcon", ctx.icon && iconContent_r6)("value", ctx.computedValue);
          ɵɵadvance(3);
...
var TuiTextareaComponent = class _TuiTextareaComponent extends AbstractTuiControl {
  constructor() {
    super(...arguments);
    this.options = inject(TUI_TEXTFIELD_OPTIONS2);
    this.isIOS = inject(TUI_IS_IOS);
    this.controller = inject(TUI_TEXTFIELD_WATCHED_CONTROLLER);
    this.hintOptions = inject(TuiHintOptionsDirective, {
      optional: true
